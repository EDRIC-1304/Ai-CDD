# =========================================================
# EFFICIENTNET-B3 MULTI-CLASS CLASSIFICATION
# =========================================================
#
# CLASSES:
# 0 -> health
...
LATEST_CHECKPOINT = os.path.join(
    CHECKPOINT_DIR,
    "latest_checkpoint_efficientnetb3_multiclass.pth"
)

BEST_MODEL_PATH = os.path.join(
    CHECKPOINT_DIR,
    "best_efficientnetb3_multiclass.pth"
)

CONF_MATRIX_PATH = os.path.join(
    CHECKPOINT_DIR,
    "confusion_matrix_efficientnetb3_multiclass.png"
)
...
print("=" * 60)
print("MULTI-CLASS INTERNAL TEST RESULTS")
print("=" * 60)
...
print("\n🎯 EfficientNet-B3 multi-class classification completed successfully")