...
# -----------------------------
# PATHS (MATCH YOUR PREPROCESS OUTPUT)
# -----------------------------
BASE_IN = "C:/Users/Ant PC/Desktop/22co12 FY_PROJ/AI-CDD/Ai-CDD/data/processed/xray_image_preprocessing"
BASE_OUT = "C:/Users/Ant PC/Desktop/22co12 FY_PROJ/AI-CDD/Ai-CDD/data/processed/xray_unet_output"
...
def process_dataset(input_dir, output_dir):
    ...
    for i, file in enumerate(tqdm(files)):
        ...
        filename = f"{i}_{os.path.splitext(file)[0]}.png"
