# =========================================================
# EFFICIENTNET-B3 TB vs SICK CLASSIFICATION
# =========================================================
#
# CLASSES:
# 0 -> sick
...
LATEST_CHECKPOINT = os.path.join(
    CHECKPOINT_DIR,
    "latest_checkpoint_efficientnet_tb_vs_sick.pth"
)

BEST_MODEL_PATH = os.path.join(
    CHECKPOINT_DIR,
    "best_efficientnet_tb_vs_sick.pth"
)

CONF_MATRIX_PATH = os.path.join(
    CHECKPOINT_DIR,
    "confusion_matrix_efficientnet_tb_vs_sick.png"
)
...
print("=" * 60)
print("EFFICIENTNET-B3 TB vs SICK RESULTS")
print("=" * 60)
...
plt.title(
    "EfficientNet-B3 TB vs Sick Confusion Matrix"
)
