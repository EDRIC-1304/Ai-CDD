# =========================================================
# RESNET18 TB vs SICK CLASSIFICATION
# =========================================================
#
# CLASSES:
# 0 -> sick
...
LATEST_CHECKPOINT = os.path.join(
    CHECKPOINT_DIR,
    "latest_checkpoint_resnet18_tb_vs_sick.pth"
)

BEST_MODEL_PATH = os.path.join(
    CHECKPOINT_DIR,
    "best_resnet18_tb_vs_sick.pth"
)

CONF_MATRIX_PATH = os.path.join(
    CHECKPOINT_DIR,
    "confusion_matrix_resnet18_tb_vs_sick.png"
)
...
print("=" * 60)
print("RESNET18 TB vs SICK INTERNAL TEST RESULTS")
print("=" * 60)
...
plt.title("ResNet18 TB vs Sick Confusion Matrix")
...
print("\n🎯 ResNet18 TB vs Sick classification completed successfully")
