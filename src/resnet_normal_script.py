...
LATEST_CHECKPOINT = os.path.join(
    CHECKPOINT_DIR,
    "latest_checkpoint_resnet18_binary.pth"
)
...
CONF_MATRIX_PATH = os.path.join(
    CHECKPOINT_DIR,
    "confusion_matrix_resnet18_binary.png"
)
...
plt.title("ResNet18 Binary Confusion Matrix")
...
print("\n🎯 ResNet18 binary classification completed successfully")