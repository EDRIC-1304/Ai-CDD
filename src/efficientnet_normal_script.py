...
LATEST_CHECKPOINT = os.path.join(
    CHECKPOINT_DIR,
    "latest_checkpoint_efficientnetb3_binary.pth"
)

BEST_MODEL_PATH = os.path.join(
    CHECKPOINT_DIR,
    "best_efficientnetb3_binary.pth"
)

CONF_MATRIX_PATH = os.path.join(
    CHECKPOINT_DIR,
    "confusion_matrix_efficientnetb3_binary.png"
)
...
print("=" * 60)
print("BINARY INTERNAL TEST RESULTS")
print("=" * 60)
...
plt.title("EfficientNet-B3 Binary Confusion Matrix")
...
print("\n🎯 EfficientNet-B3 binary classification completed successfully")